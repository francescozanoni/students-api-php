    ...
    public function run()
    {
        ...
        DB::table('audits')->insert(
            [
                ...
                'auditable_id' => 1,
                'old_values' => '[]',
                'new_values' => '{"first_name":"John","last_name":"Doe","e_mail":"john.doe@foo.com","phone":"1234-567890","nationality":"GB","id":1}',
        ...
        DB::table('audits')->insert(
            [
                ...
                'auditable_id' => 2,
                'old_values' => '[]',
                'new_values' => '{"first_name":"Jane","last_name":"Doe","e_mail":"jane.doe@bar.com","nationality":"CA","id":2}',
                'url' => 'http://localhost/students',
                'ip_address' => '::1',
                'user_agent' => 'Mozilla/5.0 (X11; Linux x86_64; rv:53.0) Gecko/20100101 Firefox/53.0',
                'tags' => null,
        ...
        DB::table('audits')->insert(
            [
                ...
                'auditable_id' => 4,
                'old_values' => '[]',
                'new_values' => '{"first_name":"Joan","last_name":"Doe","e_mail":"joan.doe@foo.com","nationality":"IE","id":4}',
                'url' => 'http://localhost/students',
                'ip_address' => '::1',
                'user_agent' => 'Mozilla/5.0 (X11; Linux x86_64; rv:53.0) Gecko/20100101 Firefox/53.0',
                'tags' => null,
