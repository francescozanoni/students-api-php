...
class SeminarAttendancesTest extends TestCase
{
    ...
    public function testModifyById()
    {
        ...
        $this->json('PUT',
            ...
            ->seeStatusCode(200)
            ->seeInDatabase('seminar_attendances', ['id' => 1, 'start_date' => '2019-01-09', 'end_date' => '2019-01-10', 'credits' => 1.0])
            ...
            ->notSeeInDatabase('seminar_attendances', ['id' => 1, 'credits' => 1.2])
            ->notSeeInDatabase('seminar_attendances', ['id' => 3]);
    ...
    public function testModifyByIdFailure()
    {
        ...
        $this->json('PUT',
            '/seminar_attendances/1',
            [
                'seminar' => 'First seminar 1', // --> modified
                'start_date' => '2019-01-08',
                'end_date' => '2019-01-09',
                'credits' => 1.2,
                'an_additional_property' => 'an additional value',
            ...
            ->seeInDatabase('seminar_attendances', ['id' => 1])
            ->notSeeInDatabase('seminar_attendances', ['id' => 1, 'seminar' => 'First seminar 1']);
